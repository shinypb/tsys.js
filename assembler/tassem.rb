...
REGISTER_PC = REGISTERS.index(:PC)
REGISTER_TC = REGISTERS.index(:TC)
REGISTER_CL = REGISTERS.index(:CL)
REGISTER_CE = REGISTERS.index(:GE)
REGISTER_CG = REGISTERS.index(:GC)
REGISTER_T = REGISTERS.index(:T)
